...
class Lexer:
    ...
    def integer(self):
        """Returns an integer value, composed from a sequence of digits."""
        result = ""
    ...
    def get_next_token(self):
        """Lexical analyzer that tokenizes input string."""
        while self.current_char is not None:
            ...
            raise LexicalError("Syntax analysis error")
...
class Parser:
    ...
    def eat(self, token_type):
        """
        Compare current token with the expected one and, if they match,
        'consume' it and move to the next one.
        """
